f = open('3 all the rest cube.txt','r+') #input
g = open('sat.txt','r+') #input
h = open('waterinj.dat','w+') #output
...
for line in g:
    ...
    if len(text) > 0: # ignore empty lines
        ...
        elif text[0] == '34' and text[1] == '34' and text[2] == '34' and water == 1: # write water; here: fractures filled with water
            h.write(line)
            h.write('\n')
            h.write('1:34 1:34 1:1   1\n')
            h.write('1:34 1:34 12:12 1\n')
            h.write('1:34 1:34 23:23 1\n')
            h.write('1:34 1:34 34:34 1\n')
            h.write('1:34 1:1 1:34   1\n')
            h.write('1:34 12:12 1:34 1\n')
            h.write('1:34 23:23 1:34 1\n')
            h.write('1:34 34:34 1:34 1\n')
            h.write('1:1 1:34 1:34   1\n')
            h.write('12:12 1:34 1:34 1\n')
            h.write('23:23 1:34 1:34 1\n')
            h.write('34:34 1:34 1:34 1\n')
        else:
            h.write(line)          
